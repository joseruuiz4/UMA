...
respuesta = [];
respuesta.append(K1.hex())
respuesta.append(K2.hex())
respuesta.append(t_nb.hex())
json_respuesta = json.dumps(respuesta)

# Cifro la respuesta con AES GCM
aes_engine = funciones_aes.iniciarAES_GCM(KBT)
cifrado, cifrado_mac, cifrado_nonce = funciones_aes.cifrarAES_GCM(aes_engine, json_respuesta.encode("utf-8"))

# Envio la respuesta a Bob
socket_Bob.enviar(cifrado)
socket_Bob.enviar(cifrado_mac)
socket_Bob.enviar(cifrado_nonce)

# Imprimo la respuesta
print("T->B (cifrado): " + json_respuesta)
...
# Imprimo la respuesta
print("T->A (cifrado): " + json_respuesta)
